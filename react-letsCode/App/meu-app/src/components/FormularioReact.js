...
class FormularioReact extends React.Component{
    ...
    return(
      <>
        <form onSubmit = {this.handleSubmit}>
            ...
            <label>
              Sou: 
              <input type="radio" checked = {this.state.tipo === 'programador'} onChange={this.changeRadio}value='programador'></input> 
              Programador 
              
              <input type="radio" checked = {this.state.tipo === 'estudante'} onChange={this.changeRadio}value='estudante'></input> 
              Estudante 

            </label>
            <br />
            <label>
              <input type="checkbox" checked={this.state.dedico} onChange={this.changeCheckbox}></input>
